...
-- Volcando estructura de base de datos para bd_sistema_gym
CREATE DATABASE IF NOT EXISTS `bd_sistema_gym` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_sistema_gym`;

-- Volcando estructura para tabla bd_sistema_gym.datos_usuario
CREATE TABLE IF NOT EXISTS `datos_usuario` (
  ...
  `año_de_nacimiento` int DEFAULT NULL,
  PRIMARY KEY (`dpi`)
...
CREATE TABLE `customer_list` (
	`ID` SMALLINT(5,0) NOT NULL,
	`name` VARCHAR(91) NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `sales_by_store` (
	`store` VARCHAR(101) NULL COLLATE 'utf8_general_ci',
	`manager` VARCHAR(91) NULL COLLATE 'utf8_general_ci',
	`total_sales` DECIMAL(27,2) NULL
) ENGINE=MyISAM;
...
-- Volcando estructura para disparador sakila.customer_create_date
...
-- Volcando estructura para disparador sakila.payment_date
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador sakila.rental_date
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_ENGINE_SUBSTITUTION';
DELIMITER //
